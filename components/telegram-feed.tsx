...
export function TelegramFeed() {
  ...
  useEffect(() => {
    ...
    script.async = true
    script.setAttribute("data-telegram-post", "ICSE_Class10_WPIV/121")
  ...
  return (
    <section className="mx-auto mt-8 max-w-5xl rounded-xl border border-border bg-card p-4 shadow-sm sm:p-5" aria-labelledby="telegram-feed-heading">
      <div className="mb-4 flex items-center justify-between gap-4">
        ...
        <a href="https://t.me/ICSE_Class10_WPIV" target="_blank" rel="noreferrer" className="shrink-0 text-sm font-semibold text-navy underline decoration-gold decoration-2 underline-offset-4">Join Telegram</a>
      </div>
